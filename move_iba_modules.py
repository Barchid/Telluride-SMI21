"""
Script used to move all developed iba_modules into the right directory inside the NRP container.
...
if __name__ == '__main__':
    print(f'MOVING MODULE SCRIPTS FROM [{SOURCE_DIR}] of this repository to the iba module location: {TARGET_DIR}')
